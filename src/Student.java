...
public class Student {
	...
	//public Student(String name2, String email2, String course2, int fee2, int paid2, int due2, String address2, String city2, String state2, String country2, String contactno2) {}
	public Student() {}
